                ...
                case 5:
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        while(true){
                           ...
                           System.out.println(enemigos.get(i).getNombre() + " ataco a " + spidermans.get(i).getNombre() + " haciendole " + enemigos.get(i).getAtaque() + " y dejandolo a " + vidaspiderman + " de vida.");
                           if(vidaspiderman<=0){
